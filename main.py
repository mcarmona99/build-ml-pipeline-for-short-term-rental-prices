...
def go(config: DictConfig):
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        if "basic_cleaning" in active_steps:
            # Get file from wandb and upload a cleaned CSV dataframe
            _ = mlflow.run(
        ...
        if "train_random_forest" in active_steps:
            # The parameterization for this step is:
            # mlflow run .
            # -P steps=train_random_forest
            # -P hydra_options=
            # "modeling.max_tfidf_features=10,15,30 modeling.random_forest.max_features=0.1,0.33,0.5,0.75,1 -m"
